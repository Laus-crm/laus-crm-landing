...
const translations = {
  fr: {
    ...
    about: {
      ...
      intro1: 'Nous sommes une société de gestion qui accompagne nos clients dans la gestion stratégique, opérationnelle et quotidienne de leurs actifs. Faire confiance à LAUS Asset Management, c\'est s\'appuyer sur une équipe d\'experts de la gestion et de l\'investissement immobilier, opérant à l\'échelle française et européenne.',
      ...
      assetClassCity: 'Hôtel',
      assetClassHostel: 'Hostel',
    ...
    activities: {
      ...
      advise: {
        ...
        content: 'Structuration et négociation des contrats\nhôteliers et immobiliers : contrats de\nmanagement (HMA), baux commerciaux,\n\ncontrats de franchise et de location-\ngérance.\n\nRéalisation d’études de faisabilité dans\nle cadre de projets de développement ou\nde transformation d’actifs.\nRecherche et sélection d’opérateurs\nhôteliers pour des actifs vacants ou en\nrepositionnement.\n\nValorisation d’actifs hôteliers et\nimmobiliers en vue d’une potentielle\nfuture vente.',
      },
      manage: {
        title: 'MANAGE',
        segment: 'Gestion d’actifs',
        content: 'Gestion active d’actifs pour le compte de\npropriétaires, avec mise en place de\nplans de capex et pilotage de leur\nexécution.\n\nOptimisation de la performance via la\nstructuration la structuration de\nstratégies de revenue management, la\nmaîtrise des coûts opérationnels et\nl’activation de leviers digitaux (web, SEO)\net marketing.\n\nSuivi opérationnel quotidien des actifs\navec l’instauration d’un système de\nreporting afin d’assurer un suivi régulier\ndes performances auprès du\npropriétaire.',
      },
      transact: {
        title: 'TRANSACT',
        segment: 'Acquisition & cession',
        content: 'Buy-side : recherche d’opportunités\nd’investissement, analyse approfondie des\nactifs et accompagnement jusqu’a la\nsignature.\n\nSell-side : gestion complète des processus\nde cession notament sur la préparation des\ndata rooms, rédaction des documents de\ncommercialisation (IM), identification et\nsélection des investisseurs, structuration\ndes opérations (asset deal / share deal) et\npilotage des négociations.\nAccompagnement des propriétaires dans\nl’optimisation des conditions de sortie, au\nbon moment, avec le bon format et au\nmeilleur prix.',
      },
    },
    portfolio: {
      title: 'Portefeuille',
      ...
      stat2: '€250M',
      stat2Label: 'Actifs sous-gestion',
      stat3: '+€1.0Md',
