...
const translations = {
  fr: {
    ...
    about: {
      ...
      bioFull: 'Ghislain est le Directeur de LAUS Asset Management, une société spécialisée dans l\'asset management et les transactions d\'hôtels et d\'actifs immobiliers en Europe. Avec plus de 6 ans d\'expérience en asset management immobilier (hôtellerie, bureaux, logistique) et en transactions (hôtellerie et bureaux), Ghislain a occupé des postes chez BNP REIM, Cushman & Wakefield et Feuring Hotel Consulting GmbH, où il a réalisé des transactions et géré des portefeuilles multi-milliardaires en actifs hôteliers, bureaux et logistique. Il est titulaire d\'un Bachelor en Hospitality Management du Glion Institute of Higher Education et d\'un Master en Immobilier et Finance de la Sorbonne.',
    ...
    activities: {
      title: 'Nos Activités',
      pageIntro: 'Nous gérons et transigeons des actifs immobiliers pour le compte de nos partenaires. Nous couvrons toutes les classes d\'actifs : hôtellerie, bureaux et logistique.',
    ...
    footer: {
      address: 'Adresse',
      addressLine: '15 Rue Pétrarque, 75116 Paris, France',
      phone: '+33 (0) 6 84 07 82 93',
      email: 'g.bussiere@laus-am.com',
